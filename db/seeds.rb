...
kite = Sport.create!(name: "Kitesurf", description: "Le Kitesurf est donc un sport nautique de traction, aussi appelé flysurf ou simplement Kite. Il consiste à glisser sur une planche de surf de taille réduite, tout en étant tracté par un cerf-volant ", image_url:"https://res.cloudinary.com/dqc8dpu1n/image/upload/v1623335140/kite_q0dcc5.jpg")
